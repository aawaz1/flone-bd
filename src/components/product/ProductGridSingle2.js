...
const ProductGridSingle2 = ({
  ...
  const navigate = useNavigate();
   ...
   return (
    <Fragment>
    { product  ?  (  <div className={clsx("product-wrap", spaceBottomClass)}>
        <div className="product-img">
          <Link to={`/product/${product?._id}`}>
            <img style={{ objectFit: "contain", height: "22vh" }}
...
export default ProductGridSingle2;